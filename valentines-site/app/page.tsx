...
export default function HomePage() {
          ...
          <div className="rounded-3xl bg-white p-10 shadow-xl ring-1 ring-black/5 sm:p-12 hover:shadow-2xl transition-shadow duration-500">
            <h2 className="text-3xl font-bold tracking-tight">My love,</h2>
             ...
             <div className="mt-6 space-y-4 text-slate-700 leading-relaxed">
              <p>
                I love you always and forever, thank you for the strength you give me, the kindness and the laughter you bring into my life.
                The way you make "ordinary" feel like something worth keeping.
              </p>
              <p>
  ...
  <div className="mt-8">
            ...
            <p className="mt-2 text-slate-700">
              Optional: add videos in <code className="rounded bg-slate-100 px-2 py-1 text-sm">public/</code> named{" "}
              <code className="rounded bg-slate-100 px-2 py-1 text-sm">us1.mp4</code>…{" "}
              <code className="rounded bg-slate-100 px-2 py-1 text-sm">us4.mp4</code>.
            </p>

...
export default function HomePage() {
  ...
  const videos = ["/us1.mp4", "/us2.mp4", "/us3.mp4", "/us4.mp4", "/us5.mp4"];
  ...
  const reasons = useMemo(
    () => [
      ...
      "You're beautiful in a way that makes my brain quiet.",
      "You're kind in a way that changes a room.",
      "You feel like home… with bonus butterflies.",
      "I'd choose you again. Easily. Every time. Always.",
      "You make boring things fun (cooking, cleaning, snoozing).",
      ...
      "I love you always and forever to the end of the universe and back .",
    ],
    []
  );
    ...
    () => [
      {
        ...
        text: "Close your eyes and remember: I'm yours. Distance is temporary, but us is forever. Also please drink water. 💧",
        emoji: "🥺",
      },
      {
        title: "Open when you're stressed",
        text: "Breathe with me: in for 4, hold for 4, out for 4. I've got you. We'll handle it together as a team. Then go play minecraft and roblox or read.",
        emoji: "😮‍💨",
      },
      {
        title: "Open when you need a smile",
        text: "You're amazing in so many ways. Like… aggressively amazing. The way you are strong headed and confident and beautiful and so capable of anything you put your mind. I'm here always cheering you on",
        emoji: "😊",
      },
      {
        title: "Open when it's late",
        text: "I love you. Goodnight. I'm proud of you. Tomorrow's gonna be great and we can yap lots more then. But for now close your eyes and rest and dream of us together, doing everything and nothing bebe ko",
        emoji: "🌙",
      },
      {
        title: "Open when you doubt yourself",
        text: "You're capable of more than you know. I've seen it. I believe in you even when you don't.I'm proud of you always and I believe in you always too",
        emoji: "💪",
      },
      {
        title: "Open when you need courage",
        text: "You've done hard things before. You'll do this too. And I'll be right here, cheering for MY SHAYLAAA loud.",
        emoji: "🦁",
      },
    ],
    []
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-rose-50 via-pink-50 to-white px-4 py-14 text-slate-800">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10">
        ...
        <div
          className="absolute left-1/2 top-[25%] h-[420px] w-[820px] -translate-x-1/2 rounded-full bg-gradient-to-r from-pink-100 via-rose-100 to-amber-100 blur-3xl opacity-60 animate-pulse-slow"
        ...
        {!opened ? (
          ...
          <section className="flex min-h-[80vh] items-center justify-center">
            <div className="w-full max-w-2xl text-center">
              ...
              <div
                className="relative mx-auto w-full animate-fade-in"
                ...
                <div className="rounded-3xl bg-white/70 p-8 shadow-xl ring-1 ring-black/5 backdrop-blur">
                  ...
                  >
                    <svg viewBox="0 0 600 380" className="block w-full">
                      ...
                      <polygon
                        points="0,380 0,90 300,240 0,380"
                        fill="#fecdd3"
                        opacity="0.95"
                      />
                      <polygon
                        points="600,380 600,90 300,240 600,380"
                        fill="#fecdd3"
                        opacity="0.95"
                      />
                      <polygon
                        points="0,380 300,220 600,380"
                        fill="#fda4af"
                        opacity="0.95"
                      />
                      <rect
                  ...
                  <p
                    className="mt-6 text-sm text-slate-600 animate-fade-in"
          ...
          <>
            ...
            <section className="mt-12 text-center">
              ...
              <h1
                className="mx-auto mt-6 max-w-3xl text-5xl font-bold tracking-tight sm:text-6xl animate-fade-in"
                style={{ animationDelay: "0.2s" }}
              >
                Hi{" "}
                <span className="text-rose-600 inline-block hover:scale-110 transition-transform cursor-default">
                  {herName}
                </span>{" "}
                —
                <br />
              ...
              <p
                className="mx-auto mt-5 max-w-2xl text-lg text-slate-700 animate-fade-in"
                style={{ animationDelay: "0.4s" }}
              >
              ...
              <p
                className="mt-4 text-sm text-slate-600 animate-fade-in"
            ...
            <section id="letter" className="mt-16 scroll-mt-8 animate-fade-in">
              <div className="rounded-3xl bg-white p-10 shadow-xl ring-1 ring-black/5 sm:p-12 hover:shadow-2xl transition-shadow duration-500">
                ...
                <div className="mt-6 space-y-4 text-slate-700 leading-relaxed">
                  <p>
                    I love you always and forever, thank you for the strength you
                    give me, the kindness and the laughter you bring into my
                    life. The way you make "ordinary" feel like something worth
                    keeping.
                  </p>
                  <p>
                    You're my favorite person to laugh with, to talk to, to do
                    nothing with, to do everything with.
                  </p>
                  <p>
                    If I ever act cool around you, just know it's an optical
                    illusion. I'm actually really really in love with you. 😌
                  </p>
                ...
                <p className="mt-2 text-slate-700">
                  A short list. Not because it's short — because the page has
                  limits.
                </p>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {reasons.map((r, i) => (
                    ...
                    >
                      ...
                      <p
                        className={`mt-2 text-slate-800 transition-all duration-500 ${
                          revealedReasons.has(i)
                            ? "opacity-100"
                            : "opacity-0 blur-sm"
                        }`}
                ...
                <h3 className="mt-12 text-2xl font-bold tracking-tight">
                  Little "Open when…" notes
                </h3>
                <p className="mt-2 text-slate-700">
                  Tiny messages for big feelings. Click to flip and reveal.
                </p>
                ...
                <h3 className="mt-12 text-2xl font-bold tracking-tight">Us 📹</h3>
                <p className="mt-2 text-slate-700">
                  Videos from <code className="rounded bg-slate-100 px-2 py-1 text-sm">public/</code>:
                  {" "}
                  <code className="rounded bg-slate-100 px-2 py-1 text-sm">us1.mp4</code>…
                  {" "}
                  <code className="rounded bg-slate-100 px-2 py-1 text-sm">us5.mp4</code>.
                </p>

                {/* ✅ grid of 5 videos (works on Pages) */}
                ...
                <div className="mt-14 rounded-3xl bg-gradient-to-r from-rose-600 via-pink-600 to-amber-500 p-[2px] shadow-2xl hover:shadow-rose-300 transition-shadow duration-500">
                  <div className="rounded-3xl bg-white p-10 text-center">
                    <p className="text-sm font-semibold text-slate-600 animate-fade-in">
                      One last thing…
                    </p>
                    <h4
                      className="mt-2 text-4xl font-bold tracking-tight animate-fade-in"
                      style={{ animationDelay: "0.2s" }}
                    >
                      Will you be my Valentine? 💘
                    </h4>
                    <p
                      className="mx-auto mt-4 max-w-2xl text-slate-700 animate-fade-in"
                      style={{ animationDelay: "0.4s" }}
                    >
                      This agreement includes cuddles, snacks, emotional support,
                      and an unreasonable amount of admiration.
                    </p>

                    <div
                      className="mt-7 flex flex-col justify-center gap-3 sm:flex-row animate-fade-in"
                      style={{ animationDelay: "0.6s" }}
                    >
                      <Link
                        href="/yes"
            ...
            <footer className="mt-14 pb-10 text-center text-sm text-slate-500">
              Made with 💞 by{" "}
              <span className="font-semibold text-slate-700">{yourName}</span> for{" "}
